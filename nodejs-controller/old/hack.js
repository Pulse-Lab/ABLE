...
var bluetoothHandlers = {
  "BD871894E156403C85C7C4C31C94DFF3":{
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAA0006":function(data){heel(data,"right")},
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAA0007":function(data){toe(data,"right")},
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAA0008":function(data){accelerometer(data,"right")},
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAA0009":function(data){mag(data,"right")},
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAA0010":function(data){gyro(data,"right")}
  }
}
...
function exploreCharacteristics(error, characteristics, parentService){
  ...
  for (i in characteristics){
    ...
    characteristics[i].on('data', bluetoothHandlers[parentService.uuid.toUpCase][characteristics[i].uuid.toUpperCase()])
